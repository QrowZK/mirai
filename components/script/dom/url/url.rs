...
impl URLMethods<crate::DomTypeHolder> for URL {
    ...
    fn CreateObjectURL_(
        _global: &GlobalScope,
        media_source: &crate::dom::mediasource::MediaSource,
    ) -> DOMString {
        DOMString::from(media_source.create_object_url())
    }

    /// <https://w3c.github.io/FileAPI/#dfn-revokeObjectURL>
    fn RevokeObjectURL(global: &GlobalScope, url: DOMString) {
        // https://w3c.github.io/media-source/#dom-url-createobjecturl
        if crate::dom::media::mediasource::MediaSource::revoke_url(&url.str()) {
            return;
        }
