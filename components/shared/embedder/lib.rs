...
pub enum EmbedderMsg {
    ...
    /// The document at this URL cannot be rendered (for example an unknown
    /// content type) and should be downloaded by the embedder instead.
    RequestDownload(WebViewId, Url, Option<String>),
